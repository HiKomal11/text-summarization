...
def generate_abstractive_summary(
    ...
    try:
        ...
        # Correct parameter structuring for HuggingFace Inference API
        params = {
        ...
        try:
            # Standard InferenceClient invocation via parameters dictionary
            ...
            # Fallback for client versions that unpack parameters directly
            summary = client.summarization(
                cleaned_input,
                model=MODEL_NAME,
                **params,
        ...
        # Handle different output formats returned by HF API
